...
--log_save_path "$HOME/Object-Handover/runs/($lr)($loss_weights)($batch_size)($glove_type)($architecture)($pose_encoder_units)($object_label_encoder_units)($object_rotation_encoder_units)($mu_var_units)($pose_decoder_units)($object_rotation_decoder_units)" \
--model_save_path "$HOME/Object-Handover/weights/($lr)($loss_weights)($batch_size)($glove_type)($architecture)($pose_encoder_units)($object_label_encoder_units)($object_rotation_encoder_units)($mu_var_units)($pose_decoder_units)($object_rotation_decoder_units)" \
--model_load_path "$HOME/Object-Handover/weights/($lr)($loss_weights)($batch_size)($glove_type)($architecture)($pose_encoder_units)($object_label_encoder_units)($object_rotation_encoder_units)($mu_var_units)($pose_decoder_units)($object_rotation_decoder_units)" \
